...
public class Main {
    public static void main(String[] args) {
        Cliente cliente = new Cliente("Cauã Ferreira", "823.446.783-00");
        Produto produto1 = new Produto("Notebook", 3000.00, CategoriaProduto.ELETRONICO);
        Produto produto2 = new Produto("Melão", 5.00, CategoriaProduto.ALIMENTO);
